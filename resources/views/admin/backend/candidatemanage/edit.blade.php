...
@section('content')
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <form method="POST"
                action="{{ isset($candidate) ? route('candidatemanage.update', $candidate) : route('candidatemanage.store') }}"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nrc_number"
                                    ...
                                    value="{{ old('nrc_number', $candidate->nrc_number ?? '') }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="date_of_birth" class="form-control" id="date_of_birth"
                                    value="{{ old('date_of_birth', isset($candidate) ? $candidate->date_of_birth?->format('Y-m-d') : '') }}">
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="gender" class="form-control select2">
                                    ...
                                    <option value="male"
                                        {{ old('gender', $candidate->gender ?? '') === 'male' ? 'selected' : '' }}>Male /
                                        ကျား</option>
                                    <option value="female"
                                        {{ old('gender', $candidate->gender ?? '') === 'female' ? 'selected' : '' }}>Female
                                        / မ</option>
                                </select>
                            </div>
