        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-12 md-12">
                <div class="card border-0 rounded-0">
                    ...
                    <div class="card-body">
                        <form action="{{ route('countrymanage.update', $country->id) }}" method="POST" id="submit-form"
...
@endsection
@push('scripts')
    {!! JsValidator::formRequest('App\Http\Requests\Backend\CountryManage\CountryUpdateRequest', '#submit-form') !!}
